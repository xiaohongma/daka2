...
int genOption(int argc, char** argv) {
//int genOption(char* pmvs_path) {
...
extern "C"{
void Java_com_example_sunbaiwan9527_myapplication_Reconstraction_genOption(JNIEnv* env, jobject thiz,jstring pmvs_path)
{
  const char* infile1;
